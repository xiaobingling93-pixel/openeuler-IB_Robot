...
class TeleopNode(Node):
    ...
    Subscribers:
        - /emergency_stop (JointState) - Emergency stop signal
    ...
    Parameters:
        ...
        - arm_joint_names (list): Arm joint names
        - gripper_joint_names (list): Gripper joint names
    """
